...
//add a new theatre
router.post("/add-theatre",getLoggedInUser, async(req,res)=>{
  try {
...
//get all theatre
router.get("/get-all-theatres", getLoggedInUser, async(req,res)=>{
    try {
...
router.post("/get-all-theatres-by-owner", getLoggedInUser,async(req,res)=>{
    try {
...
router.post("/get-all-theatres-by-movie", getLoggedInUser, async (req, res) => {
    try {
  ...
  // get show by id
router.post("/get-show-by-id", getLoggedInUser, async (req, res) => {
    try {
